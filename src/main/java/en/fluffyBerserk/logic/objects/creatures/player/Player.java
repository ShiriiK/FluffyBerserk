...
public class Player extends Creature implements CanShoot, CanAttack, CanDie {
    ...
    private void init() {
        ...
        solidArea.setX(screenX + Constant.TILE_SIZE / 10 * 4);
        solidArea.setY(screenY + Constant.TILE_SIZE / 2);
        solidArea.setWidth(Constant.TILE_SIZE / 10 * 3);
        solidArea.setHeight(Constant.TILE_SIZE / 3);
